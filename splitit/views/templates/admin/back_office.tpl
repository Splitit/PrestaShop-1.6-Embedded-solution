            ...
            <form method="post" action="{$smarty.server.REQUEST_URI|escape:'htmlall':'UTF-8'}" id="splitit_configuration">
                <table cellspacing="0" class="table">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <label> {l s='Help link title' mod='splitit'}</label>
                            </td>
                            <td>
                               <input id="help_link_title" name="help_link_title" value="{if isset($help_link_title) && $help_link_title}{$help_link_title|escape:'htmlall':'UTF-8'}{else}{l s='Tell me more' mod='splitit'}{/if}" class=" input-text" type="text">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label> {l s='Help link URL' mod='splitit'}</label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <label for="fixed_installment"> {l s='Select Installment' mod='splitit'}</label>
                            </td>
                            <td>
